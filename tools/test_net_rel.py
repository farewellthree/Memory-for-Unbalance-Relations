...
def parse_args():
    ...
    parser.add_argument(
        '--use_gt_boxes', dest='use_gt_boxes', default=True, help='use gt boxes for sgcls/prdcls', action='store_true')
    parser.add_argument(
        '--use_gt_labels', dest='use_gt_labels', default=True, help='use gt boxes for sgcls/prdcls', action='store_true')
    parser.add_argument(
        '--stage2',
        help='train with the feature',
